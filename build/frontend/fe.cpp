...
int main() {
    ...
    std::string BuildName = "Frontend Build";
    std::string BuildDescription = "Talk++ build for frontend";
    std::string BuildLogSuffix = "f";

    std::string BuildDirectory = "D:\\Projects\\TalkProject\\talk++dev";
    std::string mainCompile = "cli.cpp";
    std::string outputName = "Talk++fe.exe";
    ...
    for (const auto& file : ExtraNessecaryCppFiles) {
        finalstr = finalstr + bd + "\\src\\frontend\\" + file + " ";
    };
